...
`passport_id` INT UNIQUE NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
-- Not needet - from old course -------------

SELECT 
    man.manufacturer_id,
    man.name,
    DATE(man.established_on) AS established_on,
    m.model_id,
    m.name
...
CONSTRAINT students_exams_students
FOREIGN KEY (`student_id`)
REFERENCES `students`(`student_id`),
CONSTRAINT students_exams_exams
FOREIGN KEY (`exam_id`)
...
-- drop tables exams, students, students_exams;
